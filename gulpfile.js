...
const html = (cb) => gulp.src("index.html").pipe(gulp.dest("_out")).pipe(browserSync.stream());
const css = (cb) => gulp.src("css/styles.css")
...
const watchHTML = (cb) => gulp.watch("index.html", html);
